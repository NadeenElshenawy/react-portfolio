      ...
      <div className="contact-card">
        ...
        <div className="contact-content">
          ...
          <p className="contact-description">
            I'm available for freelance projects and collaborations. Whether you
            have a detailed Figma file or just an early-stage idea — let's talk
...
>
  Let's Work Together <span className="arrow">→</span>
          ...
          {/* Social / Direct Contact Links Footer */}
          <div className="contact-links-grid">
            <div className="link-group">
              <span className="link-title">EMAIL</span>
              <a href="mailto:nadienelshenawy@gmail.com" className="contact-link">
